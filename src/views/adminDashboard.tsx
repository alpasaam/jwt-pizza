                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {userList.users.map((u, idx) => (
                          <tr key={u.id ?? idx} className="hover:bg-gray-100">
                            <td className="px-2 py-1 text-sm text-gray-800">{u.name}</td>
                            <td className="px-2 py-1 text-sm text-gray-800">{u.email}</td>
                            <td className="px-2 py-1 text-sm text-gray-800">{u.roles?.map((r) => r.role).join(', ')}</td>
                            <td className="px-6 py-1 text-end text-sm font-medium">
